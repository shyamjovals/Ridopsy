...
public class Mapsact2 extends FragmentActivity implements OnMapReadyCallback {
   ...
   // public String fname6,fnum6,fname7,fnum7,fname8,fnum8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gps=new GPSTracker(Mapsact2.this);
    ...
    public void findleast(){
        ...
        try {
            ...
            finalduration = durarr[0];
                ...
                String abc = "Nearest is friend"+fnames[0]+": "+finaldist.toString() + " Kms away\nReaches you in " + finalduration;
                txt.setText(abc);
        }
        catch(Exception e)
        {
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                samp= db.findByIndex("{\"selector\":{\"ride\":\"" + "My Friends" + "\"}}", Schedule.class);
                hh=samp.size();
                ...
                for(int i=0;i<hh;i++)
                {
                    ...
                    fname6.add(samp.get(i).fname);
                    fnum6.add(samp.get(i).fnum);
                    fnames[i]=samp.get(i).fname;
                }
            ...
            if (result.equals("SUCCESS")) {
                ...
                mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                    ...
                    public View getInfoContents(Marker marker) {
                        LinearLayout info = new LinearLayout(Mapsact2.this);
                        info.setOrientation(LinearLayout.VERTICAL);

                        TextView title = new TextView(Mapsact2.this);
                        title.setTextColor(Color.BLACK);
                        title.setGravity(Gravity.CENTER);
                        title.setTypeface(null, Typeface.BOLD);
                        title.setText(marker.getTitle());

                        TextView snippet = new TextView(Mapsact2.this);
                ...
                for(int i=0;i<hh;i++){
                    ...
                    markerss.add(i,mMap.addMarker(new MarkerOptions().position(origin).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)).title(fname6.get(u)).snippet("Friend: "+fname6.get(u)+"\nCall: "+fnum6.get(u))));
