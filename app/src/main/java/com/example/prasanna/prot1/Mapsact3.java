...
public class Mapsact3 extends FragmentActivity implements OnMapReadyCallback {
   ...
   // public String ambname6,ambnum6,ambname7,ambnum7,ambname8,ambnum8;
    List<String>fname6=new ArrayList<>();
    List<String>fnum6=new ArrayList<>();
    ...
    Route route;
    Leg leg;
    Marker mMarker0, mMarker1, mMarker2,markerx2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gps=new GPSTracker(Mapsact3.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerx2=mMap.addMarker(new MarkerOptions().position(tmpl).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)).title("Drag and Drop").draggable(true));
    ...
    public void findleast(){
        ...
        try {
            ...
            String abc = "Nearest is Driver "+fnames[0]+": "+finaldist.toString() + " Kms away\nReaches you in " + finalduration;
            txt.setText(abc);
        }
        catch(Exception e)
        {
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                samp= db.findByIndex("{\"selector\":{\"ride\":\"" + "Ambulances" + "\"}}", Schedule.class);
                hh=samp.size();
                ...
                for(int i=0;i<hh;i++)
                {
                    ...
                    fname6.add(samp.get(i).ambname);
                    fnum6.add(samp.get(i).ambnum);
                    fnames[i]=samp.get(i).ambname;
                }
            ...
            if (result.equals("SUCCESS")) {
                ...
                mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                    ...
                    public View getInfoContents(Marker marker) {
                        LinearLayout info = new LinearLayout(Mapsact3.this);
                        info.setOrientation(LinearLayout.VERTICAL);

                        TextView title = new TextView(Mapsact3.this);
                        title.setTextColor(Color.BLACK);
                        title.setGravity(Gravity.CENTER);
                        title.setTypeface(null, Typeface.BOLD);
                        title.setText(marker.getTitle());

                        TextView snippet = new TextView(Mapsact3.this);
                ...
                for(int i=0;i<hh;i++){
                    ...
                    markerss.add(i,mMap.addMarker(new MarkerOptions().position(origin).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)).title(fname6.get(u)).snippet("Driver: "+fname6.get(u)+"\nCall: "+fnum6.get(u))));
