...
public class Mapsact5 extends FragmentActivity implements OnMapReadyCallback {
    ...
    //public String cname6,cnum6,cmodel6,ccap6,cname7,cnum7,cmodel7,ccap7,cname8,cnum8,cmodel8,ccap8;
    List<String>cname6=new ArrayList<>();
    List<String>cnum6=new ArrayList<>();
    List<String>cmodel6=new ArrayList<>();
    List<String>ccap6=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gps=new GPSTracker(Mapsact5.this);
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                samp= db.findByIndex("{\"selector\":{\"ride\":\"" + "Cabs" + "\"}}", Schedule.class);
                hh=samp.size();
                ...
                for(int i=0;i<hh;i++)
                {
                    ...
                    cname6.add(samp.get(i).cname);
                    cnum6.add(samp.get(i).cnum);
                    cmodel6.add(samp.get(i).cmodel);
                    ccap6.add(samp.get(i).ccap);
                    fnames[i]=samp.get(i).cname;
                }
            ...
            if (result.equals("SUCCESS")) {
                ...
                mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                    ...
                    public View getInfoContents(Marker marker) {
                        LinearLayout info = new LinearLayout(Mapsact5.this);
                        info.setOrientation(LinearLayout.VERTICAL);

                        TextView title = new TextView(Mapsact5.this);
                        title.setTextColor(Color.BLACK);
                        title.setGravity(Gravity.CENTER);
                        title.setTypeface(null, Typeface.BOLD);
                        title.setText(marker.getTitle());

                        TextView snippet = new TextView(Mapsact5.this);
                ...
                for(int i=0;i<hh;i++){
                    ...
                    markerss.add(i,mMap.addMarker(new MarkerOptions().position(origin).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)).title(cname6.get(u)).snippet("Driver: " + cname6.get(u) + "\nCall: " + cnum6.get(u) + "\nCar Model: " + cmodel6.get(u) + "\nCapacity: " + ccap6.get(u))));
