...
public class LoginActivityUser extends AppCompatActivity {
    ...
    Button Signup;
    public String given_uname,given_pass,email1,pass1,tosend1,tosend2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login_activity_user);
        ...
        Signup.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LoginActivityUser.this, logform.class);
                startActivity(i);
            }
        });
    ...
    private class MyTask3 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(LoginActivityUser.this, "Message", "Logging In...");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (doc.password.equals(given_pass)) {
                    // tosend1=doc.username;
                    tosend2=doc.transtop;
                    return "SUCCESS";
                }
            } catch (Exception e) {
                return e.toString();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("SUCCESS")){
                ...
                Intent n = new Intent(LoginActivityUser.this,StartupActivity.class);
                // n.putExtra("travel",tosend1);
                n.putExtra("stop",tosend2);
                //       n.putExtra("Object",doc);
                startActivity(n);
            }
            else{
