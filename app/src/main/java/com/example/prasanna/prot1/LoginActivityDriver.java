...
public class LoginActivityDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_activity_driver);
        ...
        Signup.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent i=new Intent(LoginActivityDriver.this,logformdriver.class);
                startActivity(i);
            }
        });
    }
    ...
    private class MyTask3 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(LoginActivityDriver.this, "Message", "Logging In...");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("SUCCESS")){
                ...
                Intent n = new Intent(LoginActivityDriver.this,mapslog.class);
