...
public class Ambureg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=(EditText)findViewById(R.id.tfdname);
        num=(EditText)findViewById(R.id.tfdnum);
        ...
        regi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("drive:" + name1 + num1);
                new MyTask().execute();
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(Ambureg.this, "Message", "Creating Account...");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("SUCCESS")){
                ...
                Intent n = new Intent(Ambureg.this,LoginActivityDriver.class);
